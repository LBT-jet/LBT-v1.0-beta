...
//.... uss Tdiff instead of tirad, more stable
//.... add preKT=alphas/0.3 for scaling, Ncoll22*=preKT, qhatTP*=preKT*preKT, nHQgluon*=preKT
...
//...........................................t-z coordinates	
          ...
          // .... test
//          cout << "negative four momumta and coordinates" << endl;
//          for (int itest = 0; itest < 4; itest++) {
//              cout << P0[itest][i] << "  " << V0[itest][i] << endl;
//          }
          // .... test
          ...
          //....test
          //cout << "negative, i, ti, V0[3][i], eta00, tau00" << endl;
          //cout << i << " " << ti << " " << V0[3][i] << " " << eta00 << " " << tau00 << endl;
          //....test
          ...
          {
//          // ... test 
//          cout << "negative bulklinear begin:" << i << endl; 
//          cout << ti << "  " << V0[3][i] << endl;
//          for (int itest = 0; itest < 4; itest++) {
//              cout << P0[itest][i] << "  " << V0[itest][i] << endl;
//          }
//          cout << tau00 << "   " << xxx00 << "  " << yyy00 << "   " << eta00 << "   " << ed00 << "  " << temp00 << "   " << fraction00 << "  " << VX00 << "   " << VY00 << "  " << VZ00 << endl;
//          // ... test
		  		  
		  bulklinear(tau00,xxx00,yyy00,eta00,ed00,temp00,fraction00,VX00,VY00,VZ00);

//          // ... test
//          cout << "negative bulklinear end:" << i << endl; 
//          // ... test
...
//		  qhat00=DebyeMass2(Kqhat0,0.3,temp00);
...
//          // .... test
//          cout << "positive four momumta and coordinates" << endl;
//          for (int itest = 0; itest < 4; itest++) {
//              cout << P[itest][i] << "  " << V[itest][i] << endl;
//          }
//          // .... test
//...........................................t-z coordinates	
          if(tauswitch==0)
...
//          //....test
//          if ( i == 21) {
//              cout << "positive, n, i, ti, dt, P[3][i], P[0][i] " << endl;
//              cout << n << " " << i << " " << ti << " " << dt << " " << P[3][i] << " " << P[0][i] << endl;
//          }
//          //....test
...
//          //....test
//          if ( i == 21) {
//          cout << "positive, i, ti, V[3][i], eta, tau" << endl;
//          cout << i << " " << ti << " " << V[3][i] << " " << eta << " " << tau << endl;
//
//          cout << "i, nj, ti, tiform[i]" << endl;
//          cout << i << " " << nj << " " << ti << " " << tiform[i] << endl;
//
//
//          cout << "tau, xxx, yyy, eta" << endl;
//          cout << tau << "  " << xxx << " " << yyy << " " << eta << endl;
//          }
//          //....test
          ...
          {
//          // ... test 
//          cout << "positive bulklinear begin:" << i << endl; 
//          cout << ti << "  " << V[3][i] << endl;
//          for (int itest = 0; itest < 4; itest++) {
//              cout << P[itest][i] << "  " << V[itest][i] << endl;
//          }
//          cout << tau << "   " << xxx << "  " << yyy << "   " << eta << "   " << ed << "  " << temp0 << "   " << fraction << "  " << VX << "   " << VY << "  " << VZ << endl;
//          // ... test
...
//		  qhat0=DebyeMass2(Kqhat0,0.3,temp0);
...
//              cout << kk << " " << pc0[kk] << "  " << vc0b[kk] << endl;
//          }
//          cout << pc0[0] << " " << vMag << " " << flowFactor << endl;
//
//          }
          //.. test
//...............................................................................................NEW ??????????????????????????????????????????????
...
//              cout << kk << " " << pc0[kk] << endl;
//          }
//          cout << pc0[0] << " " << sqrt(qhat0) << " " << Ecut << endl;
//          }
          //.. test
...
//............................................................................................................................................................interaction rate (scattering rate and radiation rate)
          ...
          //cout << dt << " " << flowFactor << "  " << dt_lrf << endl;
...
//                cout << "Test !!!" << endl;
//                for (int itest=0; itest<4; itest++) {
//                    cout << vc0[itest] << " " << pc0[itest] << endl;
//                }
//                cout << KATTC0 << " " << RTE << " " << PLen << " " << T << " " << endl;
//          }
...
//          cout << "lam end: " << endl;
          ...
          Ncoll22=fraction*dt_lrf*RTE/0.197*preKT;		  		  	  		  
          }
//...........................................tau-eta coordinates
          if(tauswitch==1)
		  {
          ...
          Ncoll22=fraction*dt_lrf*RTE*Xtau/0.1970*preKT;			  	  
		  }
...
//          else radng[i] = nHQgluon(KATT1[i],dt_lrf,Tdiff,temp0,E,maxFncHQ) *preKT;		  
          ...
          else radng[i] = 2 * nHQgluon(KATT1[i],dt_lrf,Tdiff,temp0,E,maxFncHQ) *preKT;		  
          }
		  if(tauswitch==1)
		  {
//          if (KATT1[i] == 21) radng[i]= 0.5 * nHQgluon(KATT1[i],dt_lrf,Tdiff,temp0,E,maxFncHQ)*Xtau *preKT;
//          else radng[i]=nHQgluon(KATT1[i],dt_lrf,Tdiff,temp0,E,maxFncHQ)*Xtau *preKT;
          if (KATT1[i] == 21) radng[i]=nHQgluon(KATT1[i],dt_lrf,Tdiff,temp0,E,maxFncHQ)*Xtau *preKT;
          else radng[i]=2*nHQgluon(KATT1[i],dt_lrf,Tdiff,temp0,E,maxFncHQ)*Xtau *preKT;
          }

//          cout << "  nHQgluon  " << radng[i] << "  " << KATT1[i] << "  " << dt_lrf << "   " << Tdiff << "  " << temp0 << "  " << E << "   "<< maxFncHQ << endl;
...
//........interaction begin 
          ...
          if(ran0(&NUM1)<Reactionrate) // !Yes, collision!		  		  
...
//              //.. test
//              if (i==21) {
//                cout << "colljet22 start" << endl;
//                  cout << "pc0: " << pc0[0] << " " << pc0[1] << " " << pc0[2] << " " << pc0[3] <<  endl;
//                  cout << "pc2: " << pc2[0] << " " << pc2[1] << " " << pc2[2] << " " << pc2[3] <<  endl;
//                  cout << "pc3: " << pc3[0] << " " << pc3[1] << " " << pc3[2] << " " << pc3[3] <<  endl;
//                  cout << "pc4: " << pc4[0] << " " << pc4[1] << " " << pc4[2] << " " << pc4[3] <<  endl;
//              }
//              //.. test
...
//          transback(vc0,pc4);
//			    if(Ejp>2*sqrt(qhat0) && ran0(&NUM1)<probNrad/Reactionrate && Kradiation==1 && qt!=0) Krad=1;
//
...
//              //.. test
//              if (i==21) {
//                cout << "colljet23 start" << endl;
//                  cout << "pc01: " << pc01[0] << " " << pc01[1] << " " << pc01[2] << " " << pc01[3] <<  endl;
//                  cout << "pc2: " << pc2[0] << " " << pc2[1] << " " << pc2[2] << " " << pc2[3] <<  endl;
//                  cout << "pc3: " << pc3[0] << " " << pc3[1] << " " << pc3[2] << " " << pc3[3] <<  endl;
//                  cout << "pc4: " << pc4[0] << " " << pc4[1] << " " << pc4[2] << " " << pc4[3] <<  endl;
//              }
...
void LBTclass::bulklinear(double tau, double x,double y,double eta,double &ed, double &temp,double &fraction,double &VX,double &VY,double &VZ)
{
  ...
  double dyh=0.3;
  double detah=0.3;  
  double dtauh=dtauhydro;

  double x0h=-10.8;
  double y0h=-10.8;
  double eta0h=-4.8;  
  double tau0h=tauhydro0;
  
 ///////////////////////////////////////////////////////////////////////////// 
// cout<< tauhydro0 << "  " << tau <<" "<< x <<" "<< y <<" "<< eta <<" "<< ed <<" "<< temp <<" "<< fraction <<" "<< VX <<" "<< VY <<" "<< VZ << endl;
 ///////////////////////////////////////////////////////////////////////////// 
...
//  // ... test 
//  cout << "in bulklinear: " << endl;
//  cout << "ix1, iy1, ieta1, itau1 " << endl;
//  cout << ix1 << "  " << iy1 << "  " << ieta1 << "  " << itau1 << "  " << endl;
//  cout << x1 << "  " << y1 << "  " << eta1 << "  " << tau1 << "  " << endl;
//  cout << xs1 << "  " << ys1 << "  " << etas1 << "  " << taus1 << "  " << endl;
//  // ... test 

  if (itau1 >= 54) itau1 = 54;
  if (itau2 >= 54) itau2 = 54;
  ...
  if (ieta1 >= 34) ieta1 = 34;
  if (ieta2 >= 34) ieta2 = 34;
...
////      cout << xs1 << "  " << ys1 << "  " << etas1 << "  " << taus1 << "  " << endl;
//
////  cout << itau1 << " " << ix1 << " " << iy1 << " " << ieta1 << endl;
//  cout << VXhydro[itau1][ix1][iy1][ieta1] << " " << VYhydro[itau1][ix1][iy1][ieta1] << " " << VZhydro[itau1][ix1][iy1][ieta1] << endl;
//  cout << pow(VXhydro[itau1][ix1][iy1][ieta1], 2) + pow(VYhydro[itau1][ix1][iy1][ieta1], 2) + pow(VZhydro[itau1][ix1][iy1][ieta1], 2) << endl; 
//// 
//  cout << VXhydro[itau2][ix2][iy2][ieta2] << " " << VYhydro[itau2][ix2][iy2][ieta2] << " " << VZhydro[itau2][ix2][iy2][ieta2] << endl;
//  cout << pow(VXhydro[itau2][ix2][iy2][ieta2], 2) + pow(VYhydro[itau2][ix2][iy2][ieta2], 2) + pow(VZhydro[itau2][ix2][iy2][ieta2], 2) << endl; 
 ///////////////////////////////////////////////////////////////////////////// 
...
//      double sp1x=p0[1];
//      double sp1y=p0[2];
//      double sp1z=p0[3];  // consider p1 is in the z direction
      double sp1x=0.0;
      double sp1y=0.0;
...
//     cout << time_gluon << "    " << temp_med << "    " << HQenergy << endl;
  ...
  //.. test
//  cout << time_gluon << " " << temp_med << " " << HQenergy << endl;
//  cout << time_num << " " << temp_num << " " << HQenergy_num << endl;
  //.. test
...
//     dtauhydro=0.3;	 
     ...
     sprintf(ratedata_route,"%s/ratedata",rate_route);   
     ...
     {
      for(int i=1;i<=45*9;i++)
	  {
          double kappaL_over_T3_g, ehat_over_T2_g, kappaL_over_T3_lq, ehat_over_T2_lq;
	  f1>>it>>ie;	 	  
	  ...
	  f1>>qhatG[it][ie]>>kappaL_over_T3_g >>ehat_over_T2_g >> Rg[it][ie]>>Rg1[it][ie]>>Rg2[it][ie]>>Rg3[it][ie]>>qhatLQ[it][ie]>> kappaL_over_T3_lq >> ehat_over_T2_lq  >>Rq[it][ie]>>Rq3[it][ie]>>Rq4[it][ie]>>Rq5[it][ie]>>Rq6[it][ie]>>Rq7[it][ie]>>Rq8[it][ie];	  
	  }
     }
     f1.close();	 
	 ...
	 char tau_route[1024];
     sprintf(tau_route,"%s/tauend.dat", bulk3D_route);   
     ifstream tauRoute(tau_route);
	 cout<<tau_route<<endl;

     tauRoute >> tauhydroend;
     cout << tauhydroend <<endl;
     ...
     sprintf(Hydroprofile_bulk3D_route,"%s/bulk3D.dat", bulk3D_route);   
     ...
     {
//         cout << ntauhydro << "   " << nxhydro << "  " << nyhydro <<  "   " << netahydro << endl;
...
//          cout << itau << "  " << ix << "  " << iy << "  " << ieta << endl;
	 f2>>temphydro[itau][ix][iy][ieta]>>VXhydro[itau][ix][iy][ieta]>>VYhydro[itau][ix][iy][ieta]>>VZhydro[itau][ix][iy][ieta];
//	 cout << temphydro[itau][ix][iy][ieta] << "  " << VXhydro[itau][ix][iy][ieta] << "  "<< VYhydro[itau][ix][iy][ieta] << "  "<< VZhydro[itau][ix][iy][ieta] << endl;

     double temp_dummy = temphydro[itau][ix][iy][ieta]; 
     if (temp_dummy < 0.184) 
         fractionhydro[itau][ix][iy][ieta] = 0;
     else if (temp_dummy > 0.220 ) 
         fractionhydro[itau][ix][iy][ieta] = 1;
     else
         fractionhydro[itau][ix][iy][ieta] = (temp_dummy - 0.184) / (0.220 - 0.184);

     if (pow(VXhydro[itau][ix][iy][ieta], 2) + pow(VYhydro[itau][ix][iy][ieta], 2) + pow(VZhydro[itau][ix][iy][ieta], 2) > 1.0) {
//        cout << "Hydro flow error !" << endl;
//        cout << itau << " " << ix << " " << iy << " " << ieta << endl;
//        cout << VXhydro[itau][ix][iy][ieta] << " " << VYhydro[itau][ix][iy][ieta] << " " << VZhydro[itau][ix][iy][ieta] << endl;
//  cout << pow(VXhydro[itau][ix][iy][ieta], 2) + pow(VYhydro[itau][ix][iy][ieta], 2) + pow(VZhydro[itau][ix][iy][ieta], 2) << endl; 
  ihydro_err++;

        //!!!!!!
        temphydro[itau][ix][iy][ieta] = 0.0;
        fractionhydro[itau][ix][iy][ieta] = 0.0;
        VXhydro[itau][ix][iy][ieta] = 0.0;
        VYhydro[itau][ix][iy][ieta] = 0.0;
        VZhydro[itau][ix][iy][ieta] = 0.0;
     } 

     if (itau >=54 || ix >=74 || iy >= 74 || ieta >= 34) {
        temphydro[itau][ix][iy][ieta] = 0.0;
        fractionhydro[itau][ix][iy][ieta] = 0.0;
        VXhydro[itau][ix][iy][ieta] = 0.0;
        VYhydro[itau][ix][iy][ieta] = 0.0;
...
//f2>>tauh>>temphydro[itau][ix][iy][ieta]>>fractionhydro[itau][ix][iy][ieta]>>VXhydro[itau][ix][iy][ieta]>>VYhydro[itau][ix][iy][ieta]>>VZhydro[itau][ix][iy][ieta];
//	  cout <<tauh << "  "  << temphydro[itau][ix][iy][ieta] << "  " <<fractionhydro[itau][ix][iy][ieta] << "   "<< VXhydro[itau][ix][iy][ieta] << "  " << VYhydro[itau][ix][iy][ieta] << "  " << VZhydro[itau][ix][iy][ieta] << endl;
      double dumpa, dumpb, dumpc;
//	  f2>>tauh>>dumpa>>dumpb>>dumpc>>ed>>temphydro[itau][ix][iy][ieta]>>fractionhydro[itau][ix][iy][ieta]>>VXhydro[itau][ix][iy][ieta]>>VYhydro[itau][ix][iy][ieta]>>VZhydro[itau][ix][iy][ieta];
//	  cout <<tauh << "  " << dumpa <<  "   " << dumpb << "  " << dumpc << "  " << ed << "  " << temphydro[itau][ix][iy][ieta] << "  " <<fractionhydro[itau][ix][iy][ieta] << "   "<< VXhydro[itau][ix][iy][ieta] << "  " << VYhydro[itau][ix][iy][ieta] << "  " << VZhydro[itau][ix][iy][ieta] << endl;
//          if (ix == nxhydro && iy == nyhydro && ieta ==netahydro) {
//          }
          ed = 0;
...
//    f2.getline(buf, 1024);
//          cout << buf << endl;
//	  cout <<(itau - 1) * 0.3 + 0.2 << "  "  << temphydro[itau][1][1][1] << "  " <<fractionhydro[itau][1][1][1] << "   "<< VXhydro[itau][1][1][1] << "  " << VYhydro[itau][1][1][1] << "  " << VZhydro[itau][1][1][1] << endl;
      }

     }
if (ihydro_err != 0) {
//    cout << "flow error:  " << ihydro_err << endl;
//    exit(1);
}
     f2.close();
...
//	 cout<<dNg_over_dt_cD6_route<<endl;
     ...
     sprintf(dNg_over_dt_qD6_route,"%s/dNg_over_dt_qD6.dat",rate_route);   
     ifstream f13(dNg_over_dt_qD6_route);
	 cout<<dNg_over_dt_qD6_route<<endl;

	 char dNg_over_dt_gD6_route[1024];
     sprintf(dNg_over_dt_gD6_route,"%s/dNg_over_dt_gD6.dat",rate_route);   
...
//     sprintf(distB_route,"%s/distB.dat",rate_route);   
...
//     sprintf(distF_route,"%s/distF.dat",rate_route);   
...
void LBTclass::LBTclear(){	        
        for(int i=1;i<=NPartons;i++)		//clear the dimensions for each event
        {
            P[1][i]=0.0;
            P[2][i]=0.0;
            P[3][i]=0.0;
...
void LBTclass::rotatePsi(double Psi, double P1[3], double P2[3])
{
  //.. Rotating P1 to align with (cos(Psi), sin(Psi), 0), and do the same rotation for P2 and update P2 in the frame 
  //.. Remember that the polor angle between P1 and P2 remains unchanged
  //.. Caution: the distribution of P2 should be symmetric with P1.
  
  double p1x = P1[0], p1y = P1[1], p1z = P1[2];
  double p2x = P2[0], p2y = P2[1], p2z = P2[2];

  double costh12 = (P1[0] * P2[0] + P1[1] * P2[1] + P1[2] * P2[2]);
  costh12 /= sqrt(pow(P1[0], 2) + pow(P1[1], 2) + pow(P1[2], 2));
  costh12 /= sqrt(pow(P2[0], 2) + pow(P2[1], 2) + pow(P2[2], 2));

  double p1pt = sqrt(pow(p1x, 2) + pow(p1y, 2));
  double p1p = sqrt(pow(p1pt, 2) + pow(p1z, 2));
  double p1theta = psi_std(p1pt, p1z);
  double p1psi = psi_std(p1x, p1y);

  double p2pt = sqrt(pow(p2x, 2) + pow(p2y, 2));
  double p2p = sqrt(pow(p2pt, 2) + pow(p2z, 2));
  double p2psi = psi_std(p2x, p2y);

  double dpsi = Psi - p1psi;
  double dpsi12 = p2psi - p1psi;

  //.. Represent (p2x, p2y) in the frame (p1x, p1y, p1z); 
  double p2x1 = p2pt * cos(dpsi12);
  double p2y1 = p2pt * sin(dpsi12);
  double p2z1 = p2z;

  //.. rotate (p2x1, p2z1) with dtheta12
  double p2pt1 = sqrt(pow(p2x1, 2) + pow(p2z1, 2));
  double p2theta = psi_std(p2x1, p2z1);
  double dtheta12 = p2theta - p1theta;
  double p2x2 = p2pt1 * cos(dtheta12);
  double p2z2 = p2pt1 * sin(dtheta12);
  double p2y2 = p2y1;

  //.. rotate (p2x2, p2y2) with dpsi
  double p2pt2 = sqrt(pow(p2x2, 2) + pow(p2y2, 2));
  double p2psi2 = psi_std(p2x2, p2y2);
  p2psi2 += p1psi;
  p2psi2 += dpsi;

  double p2x3 = p2pt2 * cos(p2psi2);
  double p2y3 = p2pt2 * sin(p2psi2);
  double p2z3 = p2z2;

  //.. update P1 and P3
  P1[0] = p1p * cos(Psi), P1[1] = p1p * sin(Psi), P1[2] = 0;
  P2[0] = p2x3, P2[1] = p2y3, P2[2] = p2z3;
  ...
  double err = fabs(costh12 - cosTh12);
  if (err > 1.0E-10) cout << "err = " << err << "\n" << endl;
}

double LBTclass::psi_std(double px, double py)
{
  double psi;
  if (px == 0 && py == 0) psi = 0;
  else if (px == 0 && py > 0) psi = M_PI / 2;
  else if (px == 0 && py < 0) psi = -M_PI / 2;
  else if (px > 0) psi = atan(py / px);
  else if (px < 0 && py >= 0) psi = M_PI + atan(py / px);
  else if (px < 0 && py < 0) psi = -M_PI + atan(py / px);
