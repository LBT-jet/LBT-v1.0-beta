...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
    ...
    TH1D *dndphi_pseudo01[ntistep];	
    TH1D *dndphi_pseudo12[ntistep];
    TH1D *dndphi_pseudo23[ntistep];
    TH1D *dndphi_pseudo34[ntistep];	
    TH1D *dndphi_pseudo24[ntistep];
    TH1D *dndphi_pseudo48[ntistep];
...
////////////////////////////////////////////////////////////////////////////
    ...
    h = "dndphi_pseudo01";    	
    dndphi_pseudo01[ik] = new TH1D(Form("dndphi_pseudo01%d",ik), "", ndphi, -Phirange, Phirange);	
	
    h = "dndphi_pseudo12";    	
    dndphi_pseudo12[ik] = new TH1D(Form("dndphi_pseudo12%d",ik), "", ndphi, -Phirange, Phirange);	

    h = "dndphi_pseudo23";    	
    dndphi_pseudo23[ik] = new TH1D(Form("dndphi_pseudo23%d",ik), "", ndphi, -Phirange, Phirange);	
	
    h = "dndphi_pseudo34";    	
    dndphi_pseudo34[ik] = new TH1D(Form("dndphi_pseudo34%d",ik), "", ndphi, -Phirange, Phirange);	
	
    h = "dndphi_pseudo24";    	
    dndphi_pseudo24[ik] = new TH1D(Form("dndphi_pseudo24%d",ik), "", ndphi, -Phirange, Phirange);	
	
    h = "dndphi_pseudo48";    	
    dndphi_pseudo48[ik] = new TH1D(Form("dndphi_pseudo48%d",ik), "", ndphi, -Phirange, Phirange);	
...
/////////////////////////////////////////////////////////////////
            ...
            if(pesudopt>0.0 && pesudopt<=1.0)
			{
			dndphi_pseudo01[ik]->Fill(phip, wwdndphi);			
			}

            if(pesudopt>1.0 && pesudopt<=2.0)
			{
			dndphi_pseudo12[ik]->Fill(phip, wwdndphi);			
			}

            if(pesudopt>2.0 && pesudopt<=3.0)
			{
			dndphi_pseudo23[ik]->Fill(phip, wwdndphi);			
			}

            if(pesudopt>3.0 && pesudopt<=4.0)
			{
			dndphi_pseudo34[ik]->Fill(phip, wwdndphi);			
			}

            if(pesudopt>2.0 && pesudopt<=4.0)
			{
			dndphi_pseudo24[ik]->Fill(phip, wwdndphi);			
			}

            if(pesudopt>4.0 && pesudopt<=8.0)
			{
			dndphi_pseudo48[ik]->Fill(phip, wwdndphi);			
			}
